...
Esta pasta contém recursos para auxiliar agentes de IA (como GitHub Copilot) a trabalhar de forma mais eficiente e consistente neste projeto.
...
- **docs/**: Recursos práticos para execução de tarefas específicas (prompts, workflows, templates)
